...
public class KafkaConfig {
    ...
    @Bean
    ProducerFactory<String, CreateCvEvent> producerFactory() {
        return new DefaultKafkaProducerFactory<>(producerConfigs());
    }

    @Bean
    KafkaTemplate<String, CreateCvEvent> kafkaTemplate(ProducerFactory<String, CreateCvEvent> producerFactory) {
